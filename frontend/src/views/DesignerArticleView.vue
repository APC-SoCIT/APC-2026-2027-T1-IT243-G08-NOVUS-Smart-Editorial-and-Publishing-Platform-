...
.specs { display: flex; gap: 26px; margin: 22px 0 16px; padding: 14px 16px;
         border: 1px solid var(--nv-line); border-radius: 8px; background: var(--nv-bg); }
.specs div { display: flex; flex-direction: column; gap: 3px; }
.specs span { font-size: 10px; letter-spacing: .6px; color: var(--nv-text-faint); }
.specs b { font-size: 13px; }
.tools { display: flex; gap: 8px; margin-bottom: 24px; }
.tools button { border: 1px solid var(--nv-line-strong); background: var(--nv-surface); border-radius: 6px;
...
.body { font-family: Georgia, serif; font-size: 17px; line-height: 1.75;
        border: 1px solid var(--nv-line); border-radius: 8px; padding: 26px; background: var(--nv-surface); }
.body :deep(h2) { font-size: 22px; margin: 22px 0 10px; }
.body :deep(p) { margin: 0 0 16px; }
.body :deep(blockquote) { border-left: 3px solid #ddd; padding-left: 14px; color: var(--nv-text-muted); }
.note { margin-top: 20px; font-size: 12px; color: var(--nv-text-faint); }
</style>
